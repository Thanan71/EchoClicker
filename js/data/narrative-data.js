...
export const NARRATIVE_DATA = {
    ...
    bosses: {
        ...
        ocean: {
            ...
            after: ["Les courants... s'apaisent...", 'Tu as dompte la tempete...', "L'ocean t'accepte..."],
        },
        montagnes: {
        ...
        foret_maudite: {
            ...
            before: ["Les tenebres t'attendent...", 'Nul ne revient de cette foret...', 'Ton ame sera mienne...'],
            after: ['Les tenebres... reculent...', 'Tu as chasse mes ombres...', 'La lumiere... me brule...'],
        },
        dimension_arcane: {
        ...
        ciel_ethere: {
            ...
            after: ["Le ciel... s'incline...", "Tu as touche l'etoile...", 'Les cieux... te reconnaissent...'],
        },
    },
